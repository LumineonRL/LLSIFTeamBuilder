...
class AccessoryFactory:
    ...
    def __init__(self, accessories_json_path: str):
        ...
        self._accessory_data_map: Dict[int, AccessoryData] = self._index_accessory_data(raw_data)
    ...
    def _index_accessory_data(self, raw_data: Dict[str, Any]) -> Dict[int, AccessoryData]:
