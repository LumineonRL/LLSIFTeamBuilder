...
class TestAccessory(unittest.TestCase):
  ...
  - Skill: Type='Appeal Boost'
    ...
    def test_invalid_accessory_level(self):
        ...
        self.assertIn(
            "Error creating accessory 1: Accessory skill_level must be between 1 and 8.",
            str(cm.warning),
        )
    ...
    def test_get_skill_for_arbitrary_level(self):
        ...
        chance_at_lvl_10 = test_accessory.get_skill_attribute_for_level(
            test_accessory.skill.chances, 10
        )
